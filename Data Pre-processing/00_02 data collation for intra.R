...
# # add two days in 2019
# cities <- unique(mobility$city_code)
# mobility2019 <- data.frame(city_code = rep(cities, 2),
#                            DATE = c(rep(20191230, length(cities)),
#                                     rep(20191231, length(cities))),
#                            outflow = NA,
#                            inflow = NA,
#                            intraflow = NA,
#                            in_outflow = NA,
#                            netflow = NA)
# mobility <- rbind(mobility2019, mobility)
...
fwrite(base192021, 'data/test data/data_base192021.csv', row.names = F)
## covid interventions
# Stringency index
...
fwrite(data, 'data/test data/all.csv', row.names = F)

data<-fread( 'data/test data/all.csv',header = T)
# read updated dates
...
fwrite(data, 'data/test data/data_all21[m].csv', row.names = F)
